...
import com.adtec.base.user.entity.Role;
import com.adtec.base.user.entity.RoleExample;
import com.adtec.base.user.service.RoleService;
...
public class RoleController {
    ...
    @ResponseBody
    public Msg saveRole(Role role, BindingResult result) {
            if (result.hasErrors()) {
