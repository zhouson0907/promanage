...
public class Constants {
    ...
    // 数据对象字段类型
    public final static Map<String, String> ItemTypeMap = new HashMap<String, String>() {
        {
            // 数据字典
            put("0", "DataDict");
            // 数据对象
    ...
    // 是否数组
    public final static Map<String, String> trueFalseMap = new HashMap<String, String>() {
        {
            // 数据字典
            put("0", "No");
            // 数据对象
