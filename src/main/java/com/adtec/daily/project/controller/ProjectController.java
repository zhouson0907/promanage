package com.adtec.daily.project.controller;
...
import com.adtec.daily.project.entity.ProjectExample;
...
public class ProjectController {
    ...
    @ResponseBody
    public Msg updateProject(Project project, BindingResult result) {
        //查询是否存在
    ...
    @ResponseBody
    public Msg saveProject(Project project, BindingResult result) {
        if (result.hasErrors()) {
