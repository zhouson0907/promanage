...
import com.adtec.daily.report.service.DailyDetailService;
import com.adtec.daily.report.service.DailyService;
import com.adtec.daily.report.service.OverWorkService;
...
import static com.adtec.base.util.DateUtil.StrToDate;
import static com.adtec.base.util.DateUtil.getWeek;
...
//    }
    ...
    @ResponseBody
    public Msg dailySaveManage(DailyDetail dailyDetail, BindingResult result) {
        ...
        try {
            ...
            if (list.size() > 0) {
                ...
                dailyDetail.setDoneDate(StrToDate(dailyDetail.getDoneDateStr()));
                ...
                //更新加班时间
                overWork(Integer.valueOf(dailyDetail.getProjectName()), offDutyDate, dailyDetail.getUserId(), StrToDate(dailyDetail.getDailyDateStr()), list.get(0).getDailyId());
            } else {
                //查询获取用户名称
                ...
                if (userList.size() > 0) {
                    ...
                    dailyDetailService.saveDailyDetail(dailyDetail);
                    //更新加班时间
                    overWork(Integer.valueOf(dailyDetail.getProjectName()), offDutyDate, dailyDetail.getUserId(), StrToDate(dailyDetail.getDailyDateStr()), dailyId);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
