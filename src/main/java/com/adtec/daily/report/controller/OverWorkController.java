...
public class OverWorkController {
    ...
    public void dailyExport(HttpServletRequest request, HttpServletResponse response,String userId,String workStartDateStr, String workEndDateStr) throws IOException {
        logger.info("导出加班补贴表开始");
        String startDate = workStartDateStr;
        String endDate = workEndDateStr;
    ...
    @ResponseBody
    public Msg updateOverWork(OverWork overWork, BindingResult result) {
